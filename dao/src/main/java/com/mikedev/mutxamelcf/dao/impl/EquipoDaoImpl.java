...
public class EquipoDaoImpl implements EquipoDao {
	...
	public Map<String, List<Equipo>> obtenerEquiposAgrupadosPorCategoria(String deporte) {
		...
		return equipos.stream().collect(Collectors.groupingBy(Equipo::getOrden));
	}
