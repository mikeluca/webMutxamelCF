...
public class NoticiaServiceImpl implements NoticiaService {
	...
	public boolean guardarNoticia(NoticiaDTO noticia) {
		return noticiaDao.guardarNoticia(toEntity(noticia));
	}
